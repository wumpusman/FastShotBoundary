...
if __name__ == '__main__':
    fake_img = torch.rand((5, 3, 20, 64, 64)) #single batch of 5 blocks that are 20 long in dpeth
    ...
    final_result = train_fake_shot.train([(fake_img, ground_truth)], 2, optimizer, is_training=True)
